...
def popular_banco():
    with app.app_context():
        ...
        # ============================================
        pacientes_dados = [
            {'nome': 'João Silva', 'email': 'joao@test.com', 'cpf': '111.111.111-11', 'nasc': '15/03/1990', 'convenio': 'Unimed'},
            {'nome': 'Maria Santos', 'email': 'maria@test.com', 'cpf': '222.222.222-22', 'nasc': '20/07/1985', 'convenio': 'Bradesco Saúde'},
            {'nome': 'Carlos Oliveira', 'email': 'carlos@test.com', 'cpf': '333.333.333-33', 'nasc': '10/11/1978', 'convenio': 'SulAmérica'},
            {'nome': 'Ana Lima', 'email': 'ana@test.com', 'cpf': '444.444.444-44', 'nasc': '05/06/1995', 'convenio': 'Amil'},
            {'nome': 'Pedro Souza', 'email': 'pedro@test.com', 'cpf': '555.555.555-55', 'nasc': '30/09/2000', 'convenio': 'Particular'},
        ]
        ...
        # ============================================
        funcionarios_dados = [
            {'nome': 'Dr. Roberto Almeida', 'email': 'roberto@lab.com', 'tipo': 'analista', 'cargo': 'Biomédico', 'salario': '8500.00', 'data': '01/02/2023', 'registro': 'CRBM-12345'},
            {'nome': 'Dra. Fernanda Costa', 'email': 'fernanda@lab.com', 'tipo': 'analista', 'cargo': 'Farmacêutica', 'salario': '9000.00', 'data': '15/03/2023', 'registro': 'CRF-54321'},
            {'nome': 'Carlos Técnico', 'email': 'carlos.tecnico@lab.com', 'tipo': 'tecnico', 'cargo': 'Técnico de Coleta', 'salario': '3500.00', 'data': '10/04/2023', 'registro': 'TEC-98765'},
            {'nome': 'Juliana Recepção', 'email': 'juliana@lab.com', 'tipo': 'recepcionista', 'cargo': 'Recepcionista', 'salario': '2800.00', 'data': '20/05/2023', 'registro': 'REC-11111'},
        ]
